...
<html>
  <head>
    <title>${sysname}</title>
    <link rel="stylesheet" href="${ctx}/skin/css/main.css" type="text/css">
  ...
  <body onselectstart="return false;" oncontextmenu="return false;">
   ...
   <div class="mask"></div>
    ...
    <div class="main">
      <div class="conDiv">
        <iframe name="content" width="100%" height="100%" frameborder="0" src="welcome"></iframe>
      </div>
    </div>

    <div class="foot">登录用户：『${user.account}』</div>
  </body>
</html>