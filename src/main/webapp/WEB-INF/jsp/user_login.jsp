...
<head>
  ...
  <style type="text/css">
    ...
    .container {
      width: 100%;
      height: 250px;
      background-image:url("${ctx}/images/login_back.jpg");
      overflow: hidden;
      position: absolute;
      left: 0px;
      top: 160px;
    ...
    .leftLogo {
      ...
      width:571px;
      height: 250px;
      background-image:url("${ctx}/images/login_logo.png");
    }
    ...
    .rightPic {
      ...
      height:250px;
      z-index:5px;
      background-image: url("${ctx}/images/login_pic.png");
    }
  ...
  <script type="text/javascript" src="${ctx}/js/user_login.js"></script>
  ...
  <div class="loginFormDiv">
    ...
    <form name="frm1" onsubmit="return false;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="loginTable">
        ...
        <tr>
          <td width="80" height="28" align="right" valign="middle">用户名：</td>
          <td width="120" align="left" valign="middle"><input  type="text" name="account" class="txt" /></td>
          <td rowspan="3" align="left" valign="middle">
            <img src="${ctx}/images/login_submitBtn1.gif" id="submitBtn" style="cursor:pointer"/>
          </td>
        </tr>
        <tr>
